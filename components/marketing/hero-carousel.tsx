...
// University list for the hero carousel
const UNIVERSITIES = [
  {
    id: "tuskegee",
    ...
    <section className="relative overflow-hidden bg-[#0a1628] text-white">
      ...
      <div className="relative py-20 md:py-32 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {showAnimation && (
            <div className="fixed inset-0 bg-[#0a1628]/80 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="text-center space-y-4">
                <div className="relative">
                  <div className="w-24 h-24 mx-auto border-4 border-[#4d94ff] border-t-transparent rounded-full animate-spin" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Shield className="h-8 w-8 text-[#4d94ff] animate-pulse" />
                  </div>
                </div>
                <div className="text-white text-lg font-semibold animate-pulse">
                  Connecting to FedSignal...
                </div>
