...
const sampleUniversities: UniversityRow[] = [
  ...
  { id: "huston-tillotson", name: "Huston-Tillotson University", acronym: "HTU", state: "TX", type: "HBCU", research: "R3", enrollment: 1100, govConScore: 65, fy25Funding: 750000, primaryColor: "#8B0000", isActive: true },
];
                ...
                {filtered.map((uni) => (
                  <tr key={uni.id} className="border-b hover:bg-muted/20 transition-colors">
                    ...
                    <td className="px-4 py-3 text-right">
                      <Button variant="ghost" size="sm" asChild>
                        <Link href={`/fedsignal/profile/${uni.id}`}>Profile</Link>
                      </Button>
                    </td>
                  </tr>
                ))}
